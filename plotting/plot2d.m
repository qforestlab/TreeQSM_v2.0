...
if nargin <= 7
    ...
    if ~iscell(Y)
        if ~isempty(X)
            if n < 9
                h = plot(X(1,:),Y(1,:),'-ob','Linewidth',lw);
            else
                h = plot(X(1,:),Y(1,:),'Color',col(1,:),'Linewidth',lw);
            end
        else
            if n < 9
                h = plot(Y(1,:),'-ob','Linewidth',lw);
            else
        ...
        if ~isempty(X)
            if n < 9
                h = plot(x,y,'-ob','Linewidth',lw);
            else
                h = plot(x,y,'Color',col(1,:),'Linewidth',lw);
            end
        else
            if n < 9
                h = plot(y,'-ob','Linewidth',lw);
            else
    ...
    if ~iscell(Y)
        if ~isempty(X)
            if n < 9
                h = errorbar(X(1,:),Y(1,:),E(1,:),'-ob','Linewidth',lw);
            else
                h = errorbar(X(1,:),Y(1,:),E(1,:),'Color',col(1,:),'Linewidth',lw);
            end
        else
            if n < 9
                h = errorbar(Y(1,:),E(1,:),'-ob','Linewidth',lw);
            else
        ...
        if ~isempty(X)
            if n < 9
                h = errorbar(x,y,e(1,:),'-ob','Linewidth',lw);
            else
                h = errorbar(x,y,'Color',e(1,:),col(1,:),'Linewidth',lw);
            end
        else
            if n < 9
                h = errorbar(y,e(1,:),'-ob','Linewidth',lw);
            else
